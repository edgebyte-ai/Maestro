...
export const AGENT_DEFINITIONS: AgentDefinition[] = [
	...
	},
	{
		...
		binaryName: 'copilot',
		command: 'copilot',
		args: ['--output-format', 'stream-json', '--yolo', '-s'],
		batchModePrefix: [],
		batchModeArgs: [],
		jsonOutputArgs: ['--output-format', 'stream-json'],
		...
		imageArgs: (imagePath: string) => ['--attachment', imagePath],
		...
		configOptions: [
			{
				...
				type: 'text',
				label: 'Model',
				description: 'Model to use (e.g., "claude-sonnet-4", "gpt-4o"). Leave empty for default.',
				default: '',
	...
	},
	{
		...
		args: ['--print', '--output-format', 'stream-json', '--yolo', '--trust'],
		batchModePrefix: [],
		batchModeArgs: [],
		jsonOutputArgs: ['--output-format', 'stream-json'],
		resumeArgs: (sessionId: string) => ['--resume', sessionId],
